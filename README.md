...
This script will:
- Get in the projects directory `cd betunfair`
...
- Generate the project documentation `mix docs`
- Initialize the Application alongside the phoenix server for the web interface. `iex -S mix phx.server`
