defmodule OperationsMatchedTest do
  ...
  setup do
    ...
    # Create users
    user_a = %User{id_users: "a", name: "User A", balance: 1000} |> Repo.insert!()
    user_b = %User{id_users: "b", name: "User B", balance: 1000} |> Repo.insert!()
    user_c = %User{id_users: "c", name: "User C", balance: 1000} |> Repo.insert!()
    user_d = %User{id_users: "d", name: "User D", balance: 1000} |> Repo.insert!()
    user_e = %User{id_users: "e", name: "User E", balance: 1000} |> Repo.insert!()
    user_f = %User{id_users: "f", name: "User F", balance: 1000} |> Repo.insert!()
    user_g = %User{id_users: "g", name: "User G", balance: 1000} |> Repo.insert!()
